...
@section('main-content')
    ...
    {{-- @elseif( Auth::user()->role && Auth::user()->role->priority == 2 )
        {{ Auth::user()->role->name }}
    @elseif( Auth::user()->role && Auth::user()->role->priority == 3 )
        {{ Auth::user()->role->name }}
    @elseif( Auth::user()->role && Auth::user()->role->priority == 4 )
        {{ Auth::user()->role->name }}
    @elseif( Auth::user()->role && Auth::user()->role->priority == 5 )
        {{ Auth::user()->role->name }}
    @elseif( Auth::user()->role && Auth::user()->role->priority == 6 )
        {{ Auth::user()->role->name }}
    @elseif( Auth::user()->role && Auth::user()->role->priority == 7 )
        {{ Auth::user()->role->name }}
    @endif --}}
